      ...
      <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        <div className="lg:col-span-6 relative">
          ...
          <FloatCard
            ...
            data-testid="hero-float-whatsapp"
          >
          ...
          <FloatCard
            ...
            data-testid="hero-float-analytics"
          >
            ...
            <div className="font-display text-2xl text-white">+342%</div>
